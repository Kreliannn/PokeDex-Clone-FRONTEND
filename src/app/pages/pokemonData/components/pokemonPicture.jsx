    ...
    return(
        ...
        <div className="flex h-52 gap-2 m-2 mt-2">
            <div className="w-[30%] bg-gray-600 border border-black shadow-lg grid grid-cols-1 ">
                <div className=' bg-red-500 m-2 border border-black  shadow'>
                    <img src={captureImg} alt="" style={{width : "100%", height : "100%"}} />
                </div>

                <div className='border border-black shadow  m-2 bg-cover bg-center bg-no-repeat' style={{backgroundImage : "url('/pokemonbg2.jpg"}}>
